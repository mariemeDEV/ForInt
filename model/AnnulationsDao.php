...
class AnnulationsDAO extends DBao
{
    ...
    public function getAnnulations(){
        $sql="SELECT p.num_police, i.matricule, i.prenom, i.nom, i.tel,i.email,a.date_annulation, a.etat_annulation,a.motif_annulation, p.etat,a.id_police FROM annulation as a 
        JOIN police as p ON(p.id_police=a.id_police)
        JOIN intermediaire as i ON(i.matricule=a.matricule_auteur)";
