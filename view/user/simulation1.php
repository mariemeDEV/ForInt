                                    ...
                                    <div class="panel-body">
                                        <div class="row"><!-- debut row -->
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <label style="margin-right: 1%;font-family: Times New Roman;font-size: 14px;position: absolute;top: 16px;left:-28px">Date effet<span style="color: red">*</span>:</label>  
                                                    <input  type ="date" onchange="CalculeBC();checkDate()" name="date_debut" class="form-control" id="date_debut" title="Date Effet" style="width: 82%;height:2em;font-size: 15px;font-family: Times New Roman;margin-left:40px;margin-top:14px;padding-left:30px !important;border-radius:.25rem;transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s;" data-toggle="popover" title="Popover Header" data-content="Date non valide" data-trigger="focus" value="">
                                                </div><!-- /input-group -->
                                            </div><!-- /.col-lg-6 -->    
                                            <div class="col-lg-6"><!-- debut col-lg-6 -->
