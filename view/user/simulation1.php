                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--4-col">
                        <div class="panel-group" id="accordion">
                            <div class="panel panel-info" style="width: 128%;height: 120;" hidden>
                                        ...
                                        <div class="row">       <!-- debut row -->
                                            <div class="col-lg-6">            <!-- debut col-lg-6 -->
                                                <div class="input-group"><!-- debut input-group -->
                                                  ...
                                                  <input type="text" style="margin-left: 7%;font-size: 15px;font-family: Times New Roman;" name="nom_assure" id="nom_assure" onchange="CalculeBC()" class="form-control"   placeholder="Nom de l'assure" aria-describedby="sizing-addon1" title="Nom de l'assure" >
                                               </div> <!-- /input-group -->
                                            </div><!-- /.col-lg-6 -->
                                            <div class="col-lg-6">             <!-- debut col-lg-6 -->
                                                <div class="input-group"><!-- debut input-group -->
                                                  <label style="margin-right: 1%;font-family: Times New Roman;font-size: 15px;margin-top: 2%;">Prenom:</label>
                                                  <input type="text" style="margin-left: 5%;font-size: 15px;font-family: Times New Roman;" name="prenom_assure" id="prenom_assure" class="form-control" onchange="CalculeBC()" placeholder="Prenom de l'assure" aria-describedby="sizing-addon1" title="Prenom de l'assure">
                                                </div> <!-- /input-group -->
                                            </div><!-- /.col-lg-6 -->
                                            <br><br><br>
                                            <div class="col-lg-6">            <!-- debut col-lg-6 -->
                            ...
                            <!-- -->
                            <div class="panel panel-info" style=" width: 128%;" hidden>
                                <div class="panel-heading" >
                                    <h3 class="panel-title">
                                        ...
                                        <div class="row">       <!-- debut row -->
                                            <div class="col-lg-6">            <!-- debut col-lg-6 -->
                                                ...
                                                <label style="margin-right: 5%;margin-top: 2%;font-family: Times New Roman;font-size: 15px;">Nom:</label>       <!-- debut input-group -->
                                                    <input type="text" style="font-size: 15px;font-family: Times New Roman;" id="nom_conducteur" name="nom_conducteur" class="form-control" placeholder="Nom du conducteur" title="Nom du conducteur" aria-describedby="sizing-addon1" >
                                                </div><!-- /input-group -->
                                            </div><!-- /.col-lg-6 -->
                                            <div class="col-lg-6">             <!-- debut col-lg-6 -->
                                                ...
                                                <label style="margin-right: 1%;margin-top: 2%;font-family: Times New Roman;font-size: 15px;">Prenom:</label>       <!-- debut input-group -->
                                                    <input  name="prenom_conducteur" style="font-size: 15px;font-family: Times New Roman;" id="prenom_conducteur" class="form-control" placeholder="Prenom du conducteur" title="Prenom du conducteur;" aria-describedby="sizing-addon1" >
                                                </div><!-- /input-group -->
                                            </div><!-- /.col-lg-6 -->
                                            <br><br><br>
                                            <div class="col-lg-6">            <!-- debut col-lg-6 -->
                                        ...
                                        <div class="row">       <!-- debut row -->
                                            ...
                                            <div class="col-lg-6">            <!-- debut col-lg-6 -->
                                                ...
                                                <div class="input-group">       <!-- debut input-group -->
                                                    ...
                                                    <input type="text" style="font-size: 15px;font-family: Times New Roman;" name="type_vehicule" class="form-control" placeholder="Type" title="Type" aria-describedby="sizing-addon1" required>
                                                </div><!-- /input-group -->
                                            </div><!-- /.col-lg-6 -->
                                            ...
                                            <br><br><br>
                                            <div class="col-lg-6">
                                                 <label style="margin-right: 1%;font-family: Times New Roman;font-size: 15px;" id="ch">Charge Utile</label>
                                                <!-- debut col-lg-6 -->
                                                <div class="input-group">       <!-- debut input-group -->
                                                    ...
                                                    <select class="custom-select col-lg-12" style="height: 30%;font-size: 15px;font-family: Times New Roman;" onchange="CalculeBC()" id="charge" name="charge">
                                                        <option value="N/A" selected>Charge Utile</option>
                                                        <option value="Break">Break</option>
                                                        <option value="Moins de 3,5T">Moins de 3,5T</option>
                                                        <option value="Plus de 3,5T">Plus de 3,5T</option>
                                                    </select>
                                                    <select class="custom-select col-lg-12" style="height: 30%;font-size: 15px;font-family: Times New Roman;" id="pack" onchange="CalculeBC()" name="pack">
                        ...
                        <div style="height: 160px;" class="panel panel-info col-lg-7">
                            ...
                            <div class="panel-body col-lg-12">
                                <table class="table  table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" class="taxes-sup" style="text-align: right" size="6" id="totalPN" disabled="disabled" />
                                            <input type="text" class="taxes-sup" name="totalPN1" size="8" id="totalPN1" hidden />
                                        </td>
                                        <td>
                                            <input type="text" class="taxes-sup"  size="6" id="totalAC"  disabled="disabled" />
                                            <input type="text" class="taxes-sup" name="accessoire" size="8" id="totalAC1" hidden />
                                        </td>
                                        <td>
                                            <input type="text" class="taxes-sup" size="6" id="taxe" disabled="disabled" />
                                            <input type="text" class="taxes-sup" name="taxe1" size="8" id="taxe1" hidden/>
                                        </td>
                                        <td>
                                            <input type="text" class="taxes-sup" style="text-align: right" size="8" id="totalFG" disabled="disabled" />
                                            <input type="text" class="taxes-sup" name="totalFG1" size="8" id="totalFG1" hidden/>
                                        </td>
                                        <td>
                                            <input type="text" class="taxes-sup" style="text-align: right" size="6" id="totalPT" disabled="disabled" />
                                            <input type="text" class="taxes-sup" name="totalPT1" size="8" id="totalPT1" hidden/>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
