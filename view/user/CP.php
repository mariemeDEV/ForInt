...
<div id="wb_Form1" style="position:absolute;left:390px;top:100px;width:250px;height:84px;z-index:24;">
    <form name="Form1" method="post" action="mailto:yourname@yourdomain.com" enctype="text/plain" id="Form1">
        ...
        <input type="text" id="Editbox5" style="position:absolute;left:334px;top:6px;width:140px;height:12px;line-height:12px;z-index:1;" name="EditboxTelS" value="<?php echo $telAssure; ?>" spellcheck="false">
        <input type="text" id="Editbox6" style="position:absolute;left:334px;top:31px;width:140px;height:12px;line-height:12px;z-index:1;" name="EditboxTelS" value="<?php echo $telAssure; ?>" spellcheck="false">
        <label for="" id="Label5" style="position:absolute;left:270px;top:5px;width:65px;height:14px;line-height:14px;z-index:2;">Téléphone</label>
        <label for="" id="Label6" style="position:absolute;left:270px;top:29px;width:65px;height:14px;line-height:14px;z-index:2;">E-mail</label>
...
<input type="text" id="Editbox3" style="position:absolute;left:490px;top:106px;width:141px;height:12px;line-height:12px;z-index:26;" name="EditboxNPS" value="<?php echo $prenomAssure." ".$nomAssure; ?>" spellcheck="false">
<img src="../../img/images3/img0002.jpg" id="Banner4" alt="PERIDOE DE GARANTIE" style="border-width:0;position:absolute;left:540px;top:161px;width:281px;height:16px;z-index:27;">
<div id="wb_Heading1" style="position:absolute;left:386px;top:210px;width:31px;height:10px;text-align:center;z-index:28;">
    <h6 id="Heading1" style="position:relative;top:-33px">Du</h6></div>
<div id="wb_Heading2" style="position:absolute;left:393px;top:244px;width:16px;height:10px;text-align:center;z-index:29;">
    <h6 id="Heading2" style='position:relative;top:-43px;display:none'>A</h6></div>
<div id="wb_Heading3" style="position:absolute;left:520px;top:210px;width:23px;height:10px;text-align:center;z-index:30;">
    <h6 id="Heading3" style="position:relative;top:-32px">Au</h6></div>
<input type="text" id="Editbox9" style="position:absolute;left:420px;top: 178px;width:82px;height:12px;line-height:12px;z-index:31;" name="EditboxDebut" value="<?php echo $dateDebut->format('d/m/Y'); ?>" spellcheck="false">
<input type="text" id="Editbox10" style="display:none;position:absolute;left:414px;top:198px;width:86px;height:12px;line-height:12px;z-index:32;" name="Editbox9" value="<?php echo $heureDebut; ?>" spellcheck="false">
<input type="text" id="Editbox11" style="position:absolute;left:547px;top:178px;width:81px;height:12px;line-height:12px;z-index:33;" name="EditboxFin" value="<?php echo $dateFin->format('d/m/Y'); ?>" spellcheck="false">
<input type="text" id="Editbox12" style="display:none;position:absolute;left:546px;top:201px;width:84px;height:12px;line-height:12px;z-index:34;" name="Editbox9" value="<?php echo $heureFin; ?>" spellcheck="false">
<input type="text" id="Editbox13" style="position:absolute;left:717px;top:179px;width:44px;height:12px;line-height:12px;z-index:35;" name="EditboxDuree" value="<?php echo $duree; ?> Mois" spellcheck="false">
<div id="wb_Line6" style="position:absolute;left:795px;top:197px;width:2px;height:29px;z-index:36;">
    <img src="../../img/images3/img0003.png" id="Line6" alt="" style="position:relative;top:-16px;display:none"></div>
<div id="wb_Heading9" style="position:absolute;left:668px;top:210px;width:37px;height:10px;text-align:center;z-index:37;">
    <h5 id="Heading9" style="position:relative;top:-30px">Durée<br></h5></div>
<div id="wb_Heading10" style="position:absolute;left:818px;top:-31px;width:144px;height:10px;text-align:center;z-index:38;">
...
<div id="wb_Line2" style="position:absolute;left:367px;top:1106px;width:600px;height:2px;z-index:83;">
    <img src="../../img/images3/img0015.png" id="Line2" alt="" style='display:none'></div>
...
<div id="wb_Form2" style="position:absolute;left:709px;top:99px;width:261px;height:85px;z-index:85;display:none !important">
    <form name="Form1" method="post" action="mailto:yourname@yourdomain.com" enctype="text/plain" id="Form2" style='display:none !important'>
...
<label class="Heading 5 <h5>" for="" id="Label17" style="position:absolute;left:683px;top:1139px;width:93px;height:22px;line-height:22px;z-index:86;display:none">Facture N°</label>
<div id="wb_Line1" style="position:absolute;left:386px;top:1156px;width:570px;height:2px;z-index:87;display:none">
...
<div id="wb_Line4" style="position:absolute;left:386px;top:1160px;width:2px;height:204px;z-index:89;display:none">
    <img src="../../img/images3/img0019.png" id="Line4" alt=""></div>
<div id="wb_Line5" style="position:absolute;left:956px;top:1160px;width:2px;height:204px;z-index:90;display:none">
    <img src="../../img/images3/img0020.png" id="Line5" alt=""></div>
<label for="" id="Label18" style="position:absolute;left:483px;top:1203px;width:36px;height:16px;line-height:16px;z-index:91;display:none"><?php echo $codeInt ;?></label>
<label for="" id="Label21" style="position:absolute;left:517px;top:1203px;width:89px;height:16px;line-height:16px;z-index:92;display:none"><?php echo $codePolice ;?></label>
<label for="" id="Label25" style="position:absolute;left:490px;top:1235px;width:150px;height:16px;line-height:16px;z-index:93;display:none"><?php echo $dateDebut->format('d/m/Y');?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $heureDebut ;?></label>
<label for="" id="Label26" style="position:absolute;left:492px;top:1263px;width:170px;height:16px;line-height:16px;z-index:94;display:none"><?php echo $dateFin->format('d/m/Y');?>&nbsp;&nbsp;&nbsp;<?php echo $heureFin ;?></label>
<label for="" id="Label27" style="position:absolute;left:554px;top:1328px;width:124px;height:16px;line-height:16px;z-index:95;display:none"><?php echo $codeInt." ".$prenomInt." ".$nomInt ;?></label>
<label for="" id="Label28" style="position:absolute;left:532px;top:1297px;width:74px;height:16px;line-height:16px;z-index:96;display:none"><?php echo strtoupper($immatriculation);?></label>
<label for="" id="Label29" style="position:absolute;left:710px;top:1180px;width:81px;height:16px;line-height:16px;z-index:97;display:none">Prime Nette</label>
<label for="" id="Label30" style="position:absolute;left:710px;top:1220px;width:101px;height:16px;line-height:16px;z-index:98;display:none">Accessoires</label>
<label for="" id="Label31" style="position:absolute;left:710px;top:1260px;width:53px;height:16px;line-height:16px;z-index:99;display:none">Taxe</label>
<label for="" id="Label32" style="position:absolute;left:710px;top:1296px;width:112px;height:16px;line-height:16px;z-index:100;display:none">Fonds de garantie</label>
<div id="wb_Line8" style="position:absolute;left:806px;top:1316px;width:140px;height:3px;z-index:101;display:none">
    <img src="../../img/images3/img0026.png" id="Line8" alt=""></div>
<div id="wb_Shape6" style="position:absolute;left:704px;top:1330px;width:121px;height:24px;z-index:102;display:none">
    <img src="../../img/images3/img0027.png" id="Shape6" alt="" style="width:121px;height:24px;"></div>
<div id="wb_Line7" style="position:absolute;left:688px;top:1160px;width:2px;height:200px;z-index:103;display:none">
...
<div id="wb_Text11" style="position:absolute;left:400px;top:1203px;width:90px;height:18px;z-index:107;">
    <span style="color:#000000;font-family:Arial;font-size:15px;display:none"><strong>Police N° :</strong></span></div>
<div id="wb_Text12" style="position:absolute;left:400px;top:1236px;width:142px;height:18px;z-index:108;">
    <span style="color:#000000;font-family:Arial;font-size:15px;display:none"><strong>Date d'effet :</strong></span></div>
<div id="wb_Text13" style="position:absolute;left:400px;top:1266px;width:142px;height:18px;z-index:109;">
    <span style="color:#000000;font-family:Arial;font-size:15px;display:none"><strong>Date d'expiration :</strong></span></div>
<div id="wb_Text14" style="position:absolute;left:400px;top:1331px;width:160px;height:18px;z-index:110;">
    <span style="color:#000000;font-family:Arial;font-size:15px;display:none"><strong>Bureau Souscription :</strong></span></div>
<div id="wb_Text15" style="position:absolute;left:400px;top:1300px;width:142px;height:18px;z-index:111;">
    <span style="color:#000000;font-family:Arial;font-size:15px;display:none"><strong>N° Immatriculation :</strong></span></div>
<div id="wb_Image3" style="position:absolute;left:378px;top:1125px;width:170px;height:39px;z-index:112;display:none">
    <img src="../../img/images3/LogoSaham1.jpg" id="Image3" alt=""></div>
<input type="text" id="Editbox18" style="position:absolute;left:768px;top:1136px;width:182px;height:15px;line-height:15px;z-index:113;display:none" name="EditboxFacture" value="<?php echo $numFacture; ?>" spellcheck="false">
<input type="text" id="Editbox19" style="position:absolute;left:866px;top:1179px;width:74px;height:16px;line-height:16px;z-index:114;display:none" name="EditboxPn" value="<?php echo number_format($nette); ?>" spellcheck="false">
<input type="text" id="Editbox20" style="position:absolute;left:866px;top:1218px;width:74px;height:16px;line-height:16px;z-index:115;display:none" name="EditboxAcc" value="<?php echo number_format($accessoire); ?>" spellcheck="false">
<input type="text" id="Editbox21" style="position:absolute;left:866px;top:1256px;width:74px;height:16px;line-height:16px;z-index:116;display:none" name="EditboxTaxe" value="<?php echo number_format($taxe) ; ?>" spellcheck="false">
