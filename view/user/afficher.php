...
<head>
    ...
    <link href="localhost/saham-app/view/style/style_aff.css" rel="stylesheet">
</head>
                        ...
                        while($row=$resultat->fetch())
                        {
                            ...
                            <td>$row[5]&nbsp;$row[4]</td>                   
                             <td style='text-align: center;'>
                                <a href='localhost/saham-app/controller/formulaire/?action=lister&id=$row[0]' onclick='if(!confirm(\"voulez - vous imprimer ? \")) return false;' target=\"_blank\"><i class=\"material-icons\">print</i></a>
                              </td>                             
                        </tr>";
                        }
                       ?>
