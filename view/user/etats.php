    ...
    <form name="Form1" method="post" action="mailto:yourname@yourdomain.com" enctype="text/plain" id="Form1">
        <input type="text" id="Editbox1" style="position:absolute;left:133px;top:13px;width:222px;height:19px;line-height:19px;z-index:0;" name="Editbox1" value="<?php echo $prenomAssure." ".$nomAssure; ?>" spellcheck="false">
